...
export default {
        ...
        return {
            batteryValue: {
                ...
                data: [
                    ...
                    { name: "堆累计充电电量", value: "-", key: "totalChargeCapacity" },
                    { name: "堆累计放电电量", value: "-", key: "totalDischargeCapacity" },
                    ...
                    // { name: "放电功率限制", value: "-", key: "allowMaxDischargePower" },
                    // { name: "充电功率限制", value: "-", key: "allowMaxChargePower" },
                    // { name: "放电电流限制", value: "-", key: "allowMaxDischargeCur" },
                    // { name: "充电电流限制", value: "-", key: "allowMaxChargeCur" },
                    ...
                    { name: "允许最大放电功率", value: "-", key: "allowMaxDischargePower" },
                    { name: "允许最大充电功率", value: "-", key: "allowMaxChargePower" }, 
            ...
            energyStorageMeter: {
                ...
                data: [
                    ...
                    { name: "日放电电量", value: "-", key: "dayChargeEnergy" },
                    { name: "日充电电量", value: "-", key: "dayDischargeEnergy" },
    ...
    components: {
        CardValue: (_) => import("./CardValue.vue"),
    },
    mounted() {
        this.getBatteryData();
    ...
    methods: {
        ...
        async getBatteryData() {
            let { data } = await api232OutdoorCabinet({ dtuId:this.currentDevice.id });
            if (data) {
                let {
                bms,
                Status,
